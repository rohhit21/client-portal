...
<body>
    ...
    <h3><i class="fa-solid fa-bars"> <select class="all-search">
     ...
     <div class="ll"><i class="fa-solid fa-fire-flame-curved"></i>Client-portals</div>
       ...
       <div class="user"><h2><a href="rohit.php" class="btn btn-sucess"><i class="fa-solid fa-user"></i></a></h2></div>
...
<hr class="line">
    ...
    <div class="box4">
      ...
      <a href="">  <div class="trending"><i class="fa-solid fa-fire"></i> Trending</div></a>
        <a href="">   <div class="shopping"><i class="fa-solid fa-cart-shopping"></i> Shopping</div></a>
            <a href=""> <div class="music"><i class="fa-solid fa-music"></i> Music</div></a>
                <a href=""><div class="moives"><i class="fa-solid fa-file-video"></i> Moives</div></a>
                    <a href="" ><div class="live"><i class="fa-solid fa-wifi"></i> live</div></a>
                        <a href="" ><div class="gaming"><i class="fa-solid fa-headset"></i> Gaming</div></a>
                            <a href="" ><div class="news"><i class="fa-solid fa-newspaper"></i> News</div></a>
                                <a href="">  <div class="courses"><i class="fa-brands fa-discourse"> </i> Courses</div></a>
                                    <a href="" > <div class="sports"><i class="fa-solid fa-dumbbell"></i> Sports</div></a>
